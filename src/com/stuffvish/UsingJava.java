...
public class UsingJava {
    public static void main(String[] args) {
        ...
        System.out.println("Enter emp Id's: ");
        for(int i = 0; i < 5; i++){
            emp_id[i] = sc.nextInt();
        }
        ...
        System.out.println();
        String[] emp_department = new String[100];
        System.out.println("Enter emp departments: ");
        for(int i = 0; i < 5; i++){
            emp_department[i] = sc.nextLine();
        }
        int[] emp_salary = new int[100];
        System.out.println("Enter emp salaries: ");
        for(int i = 0; i < 5; i++){
        ...
        for(int i = 0; i < 5; i++){
            ...
            System.out.print(" | " + emp_department[i] + " | ");
            System.out.print(" | " + emp_salary[i] + " | ");
            System.out.println();
        }
    }
